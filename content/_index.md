...
{{ cond_family(real="- transfem.social: <a rel="me" href="https://transfem.social/@newtbytes">@newtbytes@transfem.social</a>", fake="") }}
...
aren't inside jokes where i'm the only one on the inside so funny
